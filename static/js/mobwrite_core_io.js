...
ws.on('message', function( msg) {console.log( msg ); mobwrite.syncRun2_(msg + '\n');}  );
ws.on('connect', function( msg) {console.log( "connected")} );
ws.on('disconnect', function( msg) {console.log( "disconnected" )});
